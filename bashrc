...
#export PATH=$PATH:/usr/local/bin/jdk1.7.0_71/bin
export PATH=$PATH:/usr/local/bin/jdk1.8.0_102/bin
export PATH=$PATH:/home/ravi/Android/Sdk/platform-tools
export PATH=$PATH:/home/ravi/Android/Sdk/tools
alias less=$PAGER
alias zless=$PAGER
...
alias V=V.sh
alias gitlog='git log --pretty=format:"%C(yellow)%h %Cblue%>(12)%ad %Cgreen%<(16)%aN%Cred%d %Creset%s" --date=short'
